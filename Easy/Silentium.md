...
Investigando o dashboard do admin, encontrei uma api key que pode me dar permissão para interagir com o endpoint "api/v1/node-load-method/customMCP" e ter acesso ao módulo "child_process" que me permite upar um payload reverse shell .json em javascript e executar sem validação (RCE). 
