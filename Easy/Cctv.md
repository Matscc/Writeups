...
Primeiro, temos que desativar a validação no client-side que impede o uso de caracteres shell no campo image file name (Essa validação existe somente no client-side):
