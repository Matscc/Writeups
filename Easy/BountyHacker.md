...
-O tar é um programa de de compactação de extração de arquivos, mas quando tem a permissão de rodar como root ele pode ser abusado para executar comandos. O tar tem uma função "-checkpoint" e "checpoint-action" que permite executar comandos, o que podemos eplorar para alcançar o root.  
