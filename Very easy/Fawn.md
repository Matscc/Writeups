...
Utilizei o nmap para o scan das portas mais comuns com o comando: nmap -sV -sC targetip (-sV identifica a versão dos serviços encontrados, -sC roda scripts padrão nos serviços disponíveis).  
...
Já conectado, rodei o comando "ls" para buscar os arquivos diponíveis e identifiquei o arquivo "flag.txt", rodei o comando get para baixar o arquivo na minha máquina e visualizar, assim finalizando este CTF.
